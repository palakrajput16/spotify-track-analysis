...
- `popularity` ranges 0–100, right-skewed, mean ~33
...
| Recommendation system | Content-based (cosine similarity) | — | Returns musically coherent matches (0.87–0.94 similarity range) |
